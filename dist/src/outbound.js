 ...
 */
async function resolveStoredReference(to, metadata, explicitAccountId) {
 ...
 */
function normalizeA365Target(to) {
    if (!to)
        return undefined;
 ...
 */
export function normalizeA365MessagingTarget(raw) {
