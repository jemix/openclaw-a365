 ...
 *
 * Uses ChannelPlugin interface directly to ensure all adapters (agentTools,
 * gateway, messaging, directory, status) are properly registered.
 */
        ...
        setAccountEnabled: ({ cfg, accountId, enabled }) => {
            ...
            if (accounts && accountId && accountId !== DEFAULT_ACCOUNT_ID) {
                return {
                    ...
                    channels: {
                        ...cfg.channels,
                        a365: { ...a365Cfg, accounts: { ...accounts, [accountId]: { ...accounts[accountId], enabled } } },
                    },
                };
            }
